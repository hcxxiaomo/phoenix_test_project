...
//        cfg.title = cfg.title||type;
	 ...
	 * 
	 * @returns {*}
	 * modals.info("系统提示","test");
		base-modal.js:200 this={"0":"系统提示","1":"test"}
		modals.info({ title:'系统提示',text:'具体内容'})
	 * 
	 */
    modals.info = function() {
    	arguments[0]['class_info'] = 'modal-info';
    	console.info("this="+JSON.stringify(arguments));
        return _alert.call(this, arguments, 'info');
    };

    modals.correct = function() {
    	arguments[0]['class_info'] = 'modal-success';
        return _alert.call(this, arguments, 'correct');
    };

    modals.warn = function() {
    	arguments[0]['class_info'] = 'modal-warning';
        return _alert.call(this, arguments, 'warn');
    };

    modals.error = function() { 
    	arguments[0]['class_info'] = 'modal-danger';
