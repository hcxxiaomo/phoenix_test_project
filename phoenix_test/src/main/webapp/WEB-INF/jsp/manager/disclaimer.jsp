		...
		<div class="col-md-1 col-lg-1 hidden-xs hidden-sm"></div>
			...
			<div class="text-center">
				...
				<p>
					...
					【HeHe
					Journals】活動主辦方香港中文大學公共衛生及基層醫療學院不會對任何人士使用或連結本網頁而導致的任何損失或破壞（包括但不限於電腦病毒、系統固障、資料損失）承擔賠償。本方已力求確保本網站所載資料的準確性，但不會作任何明示或暗示之保證。在無事先通知下，本方保留隨時更新本免責聲明的權利。
