		...
		<div class="header-limiter">
			<ul class="nav nav-pills">
				...
				<li class="nav-item dropdown"><a
					...
					role="button" aria-haspopup="true" aria-expanded="false">訓練</a>
					<div class="dropdown-menu">
						<a class="dropdown-item" href="#">訓練一<span style=" font-size: 13px;"> (日子-日子/月份)</span></a>
						 <a	class="dropdown-item" href="#">訓練二<span style=" font-size: 13px;"> (日子-日子/月份)</span></a>
						  <a class="dropdown-item" href="#">訓練三<span style=" font-size: 13px;"> (日子-日子/月份)</span></a>
<!-- 						<div class="dropdown-divider"></div> -->
						<a class="dropdown-item" href="#">訓練四<span style=" font-size: 13px;"> (日子-日子/月份)</span></a>
						<a class="dropdown-item" href="#">訓練四<span style=" font-size: 13px;"> (日子-日子/月份)</span></a>
						<a class="dropdown-item" href="#">行動計劃</a>
						<a class="dropdown-item" href="#">檢視訓練記錄</a>
					</div></li>
